...
<body>
    ...
    <form class="form-inline definewidth m20" action="?" method="post">
        &nbsp;&nbsp;&nbsp;&nbsp;问卷标题：
        <input type="text" name="questiontype[title]" id="username" class="abc input-default" placeholder="" style="width:450px" value="">
        <hr />
        <div style="text-align:center">
            <p>问卷描述</p>
        </div>
        <textarea name="questiontype[destribe]" style="margin: 0px 0px 10px; width: 100%; height: 80px;resize: none;"></textarea>
        <br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;问卷开始时间：
        <input type="text" name="questiontype[starttime]" style="border:1px solid #999;" onclick="fPopCalendar(event,this,this)" onfocus="this.select()" readonly="readonly" />&nbsp;&nbsp; 问卷结束时间
        <input type="text" name="questiontype[endtime]" style="border:1px solid #999;" onclick="fPopCalendar(event,this,this)" onfocus="this.select()" readonly="readonly" />
        ...
        <table id="table" name="data" class="table table-bordered table-hover definewidth m10" cellpadding="3">
            <thead>
                ...
                <tr>
                    ...
                    <td>
                        <input value="" name="data[0][title]" type="text">
                    </td>
                    <td>
                        <input value="" name="data[0][a]" type="text">
                    </td>
                    <td>
                        <input value="" name="data[0][b]" type="text">
                    </td>
                    <td>
                        <input value="" name="data[0][c]" type="text">
                    </td>
                    <td>
                        <input value="" name="data[0][d]" type="text">
                    </td>
                    <td><a>删除</a></td>
                </tr>
                </tr>

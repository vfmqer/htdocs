...
<body>
    ...
    <form class="form-inline definewidth m20" action="?" method="post">
        &nbsp;&nbsp;&nbsp;&nbsp;问卷标题：
        <input type="text" name="questiontype[title]" id="username" class="abc input-default" placeholder="" style="width:450px" value="<?php echo ($result_lessons["title"]); ?>">
        <hr />
        <div style="text-align:center">
            <p>问卷描述</p>
        </div>
        <textarea name="questiontype[destribe]" style="margin: 0px 0px 10px; width: 100%; height: 80px;resize: none;"><?php echo ($result_lessons["destribe"]); ?></textarea>
        <br /> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;问卷开始时间：
        <input type="text" value="<?php echo ($result_lessons["starttime"]); ?>" name="questiontype[starttime]" style="border:1px solid #999;" onclick="fPopCalendar(event,this,this)" onfocus="this.select()" readonly="readonly" />&nbsp;&nbsp; 问卷结束时间
        <input type="text" value="<?php echo ($result_lessons["endtime"]); ?>" name="questiontype[endtime]" style="border:1px solid #999;" onclick="fPopCalendar(event,this,this)" onfocus="this.select()" readonly="readonly" />
        <button type="button" class="btn btn-success" onclick="addRow()" id="addnew">添加问题</button>
        <table id="table" name="data" class="table table-bordered table-hover definewidth m10" cellpadding="3">
            <thead>
                ...
                <?php if(is_array($res)): foreach($res as $k=>$vo): ?><input value="<?php echo ($id1); ?>" type="hidden" name="id1" type="text">
                ...
                <tr>
                    ...
                    <td>
                        <input value="<?php echo ($vo["title"]); ?>" name="data[<?php echo ($k); ?>][title]" type="text">
                    </td>
                    <td>
                        <input value="<?php echo ($vo["a"]); ?>" name="data[<?php echo ($k); ?>][a]" type="text">
                    </td>
                    <td>
                        <input value="<?php echo ($vo["b"]); ?>" name="data[<?php echo ($k); ?>][b]" type="text">
                    </td>
                    <td>
                        <input value="<?php echo ($vo["c"]); ?>" name="data[<?php echo ($k); ?>][c]" type="text">
                    </td>
                    <td>
                        <input value="<?php echo ($vo["d"]); ?>" name="data[<?php echo ($k); ?>][d]" type="text">
                    </td>
                    <td><a>删除</a></td>
                </tr>
...
function addRow() {
    ...
    newTd1.innerHTML = '<input  value="" name=data[' + rows + '][title] type="text" >';

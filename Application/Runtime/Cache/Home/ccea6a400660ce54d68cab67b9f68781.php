...
<body>
    <div class="login_box">
        <div class="login_text">
            <form name="myform" method="post" action="<?php echo U('index/login');?>">
                <P>用户名：
                    <input class="text_bg" type="text" name="username">
                </P>
                <P>密  码：
                    <input style="margin-left:6px;" class="text_bg" type="password" name="password">
                </P>

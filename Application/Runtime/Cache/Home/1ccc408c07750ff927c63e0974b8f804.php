...
<table class="table table-bordered table-hover definewidth m10">
    ...
    <tr>
        ...
        <?php if(is_array($resultuser)): foreach($resultuser as $key=>$vo): ?><tr>
            ...
            <td>
                <a href="<?php echo U('Index/user_edit');?>?id=<?php echo ($vo["id"]); ?>">编辑</a>                
                <a href="<?php echo U('Index/user_delete');?>?id=<?php echo ($vo["id"]); ?>">删除</a>                         
            </td>
...
<script>
    $(function () {
		...
		$('#addnew').click(function(){
				...
				window.location.href="<?php echo U('Index/user_add');?>";
		 });
